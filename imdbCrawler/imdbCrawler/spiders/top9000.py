...
class IMDBCrawler(scrapy.Spider):
    ...
    start_urls =['https://www.imdb.com/search/title/?title_type=movie&sort=boxoffice_gross_us,desc&explore=title_type,genres']
    ...
    def parseAMovie(self,response):
        ...
        data['Studios']=response.xpath('//*[text()="Production company" or text()="Production companies"]/..//li[@class="ipc-inline-list__item"]/a/text()').getall()
        ...
        data['Languages']=response.xpath('//*[text()="Languages" or text()="Language"]/..//li[@class="ipc-inline-list__item"]/a/text()').getall()
        #Certificate After
        data['Countries']=response.xpath('//*[text()="Country of origin" or text()="Countries of origin"]/..//li[@class="ipc-inline-list__item"]/a/text()').getall()
        #Missing Production Method
        data['Filming_Location']=response.xpath('//*[text()="Filming locations" or text()="Filming location"]/..//li[@class="ipc-inline-list__item"]/a/text()').getall()
        ...
        data['Rating_Count']=response.xpath('//*[@data-testid="hero-rating-bar__aggregate-rating__score"]/../div[3]/text()').get()
        yield data
